...
module cache_checker #(
    ...
    output        cpu_req,        //��CPU������Cache
    output [31:0] cpu_addr,       //��CPU������Cache
    input  [31:0] cache_rdata,    //��Cache���ظ�CPU
    input         cache_addr_ok,  //��Cache���ظ�CPU
    input         cache_data_ok   //��Cache���ظ�CPU
);
